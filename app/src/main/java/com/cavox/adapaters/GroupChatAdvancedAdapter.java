...
public class GroupChatAdvancedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private enum Actions { DEFAULT,AUDIOPLAY,AUDIOPAUSE,UPLOAD,UPLOADCANCEL,DOWNLOAD,DOWNLOADCANCEL}

    String TAG = GroupChatAdvancedAdapter.class.getSimpleName();
...
*/
    ...
    public GroupChatAdvancedAdapter(Context context, Cursor c, String mydestination) {
...
/*
            ...
            sendLayout.setOnLongClickListener(this);

            dateView.setOnClickListener(this);
            dateView.setOnLongClickListener(this);

            sendMessage.setOnClickListener(this);
            sendMessage.setOnLongClickListener(this);
            statusandtime_layout.setOnClickListener(this);
            statusandtime_layout.setOnLongClickListener(this);
            failedtext.setOnClickListener(this);
            failedtext.setOnLongClickListener(this);
            sentIcon.setOnClickListener(this);
            sentIcon.setOnLongClickListener(this);
            deliveredIcon.setOnClickListener(this);
            deliveredIcon.setOnLongClickListener(this);
            sentIcon1.setOnClickListener(this);
            sentIcon1.setOnLongClickListener(this);
            deliveredIcon1.setOnClickListener(this);
            deliveredIcon1.setOnLongClickListener(this);
            sendTime.setOnClickListener(this);
            sendTime.setOnLongClickListener(this);
            contactimageview.setOnClickListener(this);
            contactimageview.setOnLongClickListener(this);
*/
            //Log.i(TAG,"MyViewHolder1 is called");
        }
        @Override
        public void onClick(View v) {
            ...
            /*if (v.getId() == sendMessage.getId()){
                Log.i(TAG,"sendMessage clicked");
                processClick(0,adapterPosition,Actions.SENDERCONTACT,1,sendMessage);
            } else if (v.getId() == contactimageview.getId()) {
                Log.i(TAG,"contactimageview clicked");
                //processClick(0,adapterPosition,0);
            }
*/
        }
...
/*
    ...
    public class MyViewHolder3 extends RecyclerView.ViewHolder implements View.OnClickListener , View.OnLongClickListener {
        ...
        RelativeLayout receiveLayout;
        TextView dateView;
        TextView receiveTime,sendernameview;
        TextView receiveMessage;
        ImageView contactimageview;
        ...
        public MyViewHolder3(View view) {
            ...
            contactimageview = (ImageView) view.findViewById(R.id.contactplaceholder);
            sendernameview = (TextView) view.findViewById(R.id.sendername);
...
*/
    ...
    public class MyViewHolder4 extends RecyclerView.ViewHolder implements View.OnClickListener , View.OnLongClickListener,SeekBar.OnSeekBarChangeListener {
        ...
        TextView dateView;
        TextView receiveTime,audiolengthview,sendernameview;
        RelativeLayout receive_image_layout;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View defaultitemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_grp_item_empty, parent, false);
        //Log.i(TAG,"ItemViewType in onCreateViewHolder:" + viewType);
        try {
            switch (viewType) {
                case 0:
                    View itemView0 = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_grp_item_empty, parent, false);
                    return new MyViewHolder0(itemView0);
                case 1:
                    View itemView1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_grp_item1, parent, false);
                    return new MyViewHolder1(itemView1);
                case 2:
                    View itemView2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_grp_item2, parent, false);
                    return new MyViewHolder2(itemView2);
                case 3:
                    View itemView3 = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_grp_item3, parent, false);
                    return new MyViewHolder3(itemView3);
                case 4:
                    View itemView4 = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_grp_item4, parent, false);
                    return new MyViewHolder4(itemView4);
                case 5:
                    View itemView5 = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_grp_item2_multidevice_chat, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewholder, final int position) {
        try {
            ...
            //LOG.info("Chat id:"+cursor.getString(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_ID)));
            //LOG.info("Chat message:"+cursor.getString(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_MESSAGE)));
            ...
            switch (viewholder.getItemViewType()) {
                ...
                case 6:
                    viewHolder6 = (MyViewHolder6)viewholder;
...
*/
                ...
                case 3:
                    ...
                    viewHolder3.sendernameview.setText(cursor.getString(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_GROUP_MESSAGE_SENDER_NAME)));
                    if (cursor.getInt(cursor.getColumnIndex(CSDbFields.KEY_CHAT_MSG_TYPE)) == CSConstants.E_TEXTPLAIN || cursor.getInt(cursor.getColumnIndex(CSDbFields.KEY_CHAT_MSG_TYPE)) == CSConstants.E_TEXTHTML || cursor.getInt(cursor.getColumnIndex(CSDbFields.KEY_CHAT_MSG_TYPE)) == CSConstants.E_UNKNOWN_CHAT_TYPE) {
                        String message = cursor.getString(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_MESSAGE));
...
*/
                    ...
                    if(cursor.getInt(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_STATUS))== CSConstants.MESSAGE_RECEIVED   || cursor.getInt(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_STATUS))== CSConstants.MESSAGE_DELIVERED_ACK || cursor.getInt(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_STATUS)) == CSConstants.MESSAGE_DELIVERED) {
                        ...
                        //to do  this.changeCursor(CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID,destination));
                ...
                case 4:
                    ...
                    viewHolder4.sendernameview.setText(cursor.getString(cursor.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_GROUP_MESSAGE_SENDER_NAME)));
...
*/
    ...
    public void processClick(int clicktype,int cursorposition,int viewtype,View view,Actions action) {
        try {
            ...
            Cursor cur = CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID,this.destination); //this can be sensitive and cause issues on notify date set changed when on long click. take care(delete is fine since after delete we are exiting from onlong click slection )
            ...
            GroupChatAdvancedActivity.handlelongclick(selectedpositions);
...
openFile(finalfilepathuri,contenttype);
                                    ...
                                    uploaddownloadhelper(action,chatid,GlobalVariables.imagedirectoryreceived+File.separator+mainkey);
                                }
                                ...
                                if(action == Actions.DEFAULT) {
                                    ...
                                    uploaddownloadhelper(action,chatid,GlobalVariables.videodirectoryreceived+File.separator+mainkey);
                                }
                                ...
                                if(action == Actions.DEFAULT) {
                                    ...
                                    uploaddownloadhelper(action,chatid,GlobalVariables.docsdirectoryreceived+File.separator+mainkey);
                                }
                                ...
                                if(action == Actions.DEFAULT) {
                                    ...
                                    if (finalfilepathuri != null) {
                                        ...
                                        swapCursorAndNotifyDataSetChanged(CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID, destination), false, "");
                                    } else {
                                    ...
                                    uploaddownloadhelper(action,chatid,GlobalVariables.audiodirectoryreceived+File.separator+mainkey);
                                }
                        }
                    }
