...
import com.cavox.CustomViews.MyProgressDialog;
import com.cavox.adapaters.GroupChatAdvancedAdapter;
import com.cavox.utils.App;
import com.cavox.utils.AppConstants;
import com.cavox.utils.ChatConstants;
import com.cavox.utils.ChatMethodHelper;
...
public class GroupChatAdvancedActivity extends AppCompatActivity implements Animation.AnimationListener {
	...
	RecyclerView rv;
	String TAG = GroupChatAdvancedActivity.class.getSimpleName();
    private PreferenceProvider mPrefereceProvider;
	GroupChatAdvancedAdapter adp;
    ...
    private static ImageView chatdeleteview,chatcopyview,chatforwardview,backviewsearch,chatinfoview;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        chatinfoview = findViewById(R.id.chatinfo);
		...
		isGroupChat = getIntent().getBooleanExtra("IS_GROUP", true);
        ...
        DividerItemDecoration divider = new DividerItemDecoration(GroupChatAdvancedActivity.this, DividerItemDecoration.VERTICAL);
        divider.setDrawable(ContextCompat.getDrawable(getBaseContext(), R.drawable.custom_divider));
        rv.addItemDecoration(divider);
        adp = new GroupChatAdvancedAdapter(GroupChatAdvancedActivity.this, CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID,destination),destination);
		rv.setNestedScrollingEnabled(false);
		rv.setLayoutManager(mLayoutManager);
		rv.setItemAnimator(new DefaultItemAnimator());
		rv.setAdapter(adp);
        //LOG.info("TEST DELAY 8:"+new SimpleDateFormat("hh:mm:ss.SSS a").format(new Date().getTime()));

        slideDown = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.slide_down_menu);
        slideDown.setAnimationListener(GroupChatAdvancedActivity.this);
        slideUp = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.slide_up_menu);
        //LOG.info("TEST DELAY 9:"+new SimpleDateFormat("hh:mm:ss.SSS a").format(new Date().getTime()));
 ...
 */
        ...
        edittextsearchchatview.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    GroupChatAdvancedActivity.this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
                }
            } });
        ...
        //LOG.info("TEST DELAY 16:"+new SimpleDateFormat("hh:mm:ss.SSS a").format(new Date().getTime()));
        ...
        toolbar_title_layout_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor ccfr = CSDataProvider.getGroupsCursorByFilter(CSDbFields.KEY_GROUP_ID, destination);
                if (ccfr.getCount() > 0) {
                    isgrpactive = true;
                }
                ccfr.close();
                ...
                if (isgrpactive) {
                    Intent intent = new Intent(MainActivity.context, ManageGroupActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra("grpid", destination);
                    MainActivity.context.startActivity(intent);
                } else {

                    Toast.makeText(getApplicationContext(), "Group already deleted!", Toast.LENGTH_SHORT).show();
        ...
        //LOG.info("TEST DELAY 17:"+new SimpleDateFormat("hh:mm:ss.SSS a").format(new Date().getTime()));
...
if(!chatMessage.equals("")) {
    ...
    notifyDataSetChanged(true,false,"",true);
        ...
        mLocationLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(GroupChatAdvancedActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 102);
                }
        ...
        mContactLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideAttachmentMenu();
                Intent contactPickerIntent = new Intent(GroupChatAdvancedActivity.this, ShareContactsInChatActivity.class);
        ...
        mDocumentsLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(GroupChatAdvancedActivity.this, "Please install a File Manager.", Toast.LENGTH_SHORT).show();
                }
        ...
        //LOG.info("TEST DELAY 19:"+new SimpleDateFormat("hh:mm:ss.SSS a").format(new Date().getTime()));
        ...
        mCameraLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String CHAT_IMAGES_DIRECTORY = Environment.getExternalStorageDirectory().toString() + "/deltacubes/Images";
                ...
                Log.i(TAG, "Image Path: " + imageFile);
                   ...
                   if(ContextCompat.checkSelfPermission(GroupChatAdvancedActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(GroupChatAdvancedActivity.this, new String[]{Manifest.permission.CAMERA}, 101);
                }
            }
        });
            ...
            public void onClick(View v) {
                if (!attachmentslayout.isShown()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        float finalRadius = (float) Math.hypot(width, getResources().getDimension(R.dimen._150sdp));

                        // Android native animator
                        Animator animator =
                                ViewAnimationUtils.createCircularReveal(myView, 0, (int) getResources().getDimension(R.dimen._150sdp), 0, finalRadius);
        ...
        //LOG.info("TEST DELAY 20:"+new SimpleDateFormat("hh:mm:ss.SSS a").format(new Date().getTime()));

        RunnableObj = new Runnable() {
            public void run() {
                h.postDelayed(this, delay);
                //Log.i(TAG,"printing at 1 sec");
                GroupChatAdvancedActivity.this.runOnUiThread(new Runnable() {
                    public void run() {
                        String minutes = "00";
                        String seconds = "00";
                        int x = startTime++;
                        ...
                        try {
                            ...
                            if (Integer.parseInt(duration) > 1000) {
                                if(new File(AudioSavePathInDevice).exists()) {
                                    ...
                                    Toast.makeText(GroupChatAdvancedActivity.this, getString(R.string.media_not_available), Toast.LENGTH_LONG).show();
                                }
                            } else {
        ...
        mRecordButton.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                Toast.makeText(GroupChatAdvancedActivity.this, getString(R.string.chat_screen_audio_start_message),
        ...
        mChatMessageEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (mChatMessageEditText.getText().toString().length() == 1 || mChatMessageEditText.getText().toString().length() % 3 == 1) {
                    ...
                    CSChatObj.sendIsTyping(destination, true, true);
                }
                if (s.length() > 0) {
...
try {
    ...
    Toast.makeText(GroupChatAdvancedActivity.this, "Copied to clipboard", Toast.LENGTH_LONG).show();
    ...
    ex.printStackTrace();
        ...
        chatforwardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent contactPickerIntent = new Intent(getApplicationContext(), ShowCORGMultiSelectActivity.class);
        ...
        chatinfoview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    ...
                    for(int cursorposition:selectedpositions) {
                        cur.moveToPosition(cursorposition);
                        chatid =  cur.getString(cur.getColumnIndex(CSDbFields.KEY_CHAT_ID));
                        break;
                    }
                    cur.close();

                    Intent contactPickerIntent = new Intent(getApplicationContext(), GroupMessageInfoActivity.class);
                    contactPickerIntent.putExtra("chatid", chatid);
                    startActivityForResult(contactPickerIntent, 898);
        ...
        if (mPrefereceProvider.getPrefBoolean(PreferenceProvider.IS_FILE_SHARE_AVAILABLE)) {
            ...
            if (isFileAvailable) {
                ...
                if (receivedFileType.equals("text")) {
                    CSChatObj.sendMessage(destination, receivedFilePath, true);
                    ...
                    if (filepath.equals("")) {
                        ...
                        CSChatObj.sendPhoto(destination, filepath, true);
                    ...
                    if (filepath.equals("")) {
                        ...
                        Log.i(TAG, "not showing toast:" + filepath);
                        //new ForeGroundServiceApis().startChatService(getApplicationContext(),destination,"Sending video");
                        CSChatObj.sendVideo(destination, filepath, true);
    ...
    private void hideAttachmentMenu() {
        ...
        if (attachmentslayout.isShown()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                Animator animator = ViewAnimationUtils.createCircularReveal(myView, myView.getLeft(), (int) getResources().getDimension(R.dimen._150sdp), finalRadius, 0);
                animator.setInterpolator(new AccelerateDecelerateInterpolator());
                animator.setDuration(300);
                animator.start();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		//SearchView searchViewAction = (android.support.v7.widget.SearchView)searchMenuItem.getActionView();
		SearchView searchViewAction = (SearchView) MenuItemCompat.getActionView(searchMenuItem);

        ComponentName componentName = new ComponentName(getApplicationContext(), ChatAdvancedActivity.class);
		...
		searchMagIcon.setImageResource(R.drawable.searchnew);

		Log.i(TAG, "searchViewAction:" + searchViewAction);
		...
		searchViewAction.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
			...
			public boolean onQueryTextSubmit(String query) {
				...
				Log.i(TAG, "string query onQueryTextSubmit:" + query);
			...
			public boolean onQueryTextChange(String query) {
				...
				Log.i(TAG, "string query onQueryTextChange:" + query);
...
*/
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			/*
			case R.id.audiocall:
				utils.donewvoicecall(destination, GroupChatAdvancedActivity.this);
				return true;

			case R.id.videocall:
				utils.donewVideocall(destination, GroupChatAdvancedActivity.this);
				return true;
            ...
            try {
                ...
                if (intent.getAction().equals(CSEvents.CSCLIENT_NETWORKERROR)) {
                    ...
                    if (intent.getStringExtra(CSConstants.RESULT).equals(CSConstants.RESULT_SUCCESS)) {
                        String name = utils.getGroupname(destination);
                        if (name.equals("")) {
                            //toolbar.setTitle("Unknown Group");
                            ...
                            if (CSDataProvider.getLoginstatus()) {
                                ...
                                CSGroupsObj.pullGroupDetails(destination);
                            }
                        }
                        //} else {
                    ...
                    if (destination.equals(intent.getStringExtra("destinationgroupid")) && istyping) {
                        LOG.info("isTypingReq:" + destination);
                        LOG.info("isTypingReq1:" + intent.getStringExtra("destinationnumber"));
                        final String destinationnumberr = intent.getStringExtra("destinationnumber");
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String name = "";
                                        Cursor cct = CSDataProvider.getContactCursorByNumber(destinationnumberr);
                                if (cct.getCount() > 0) {
                                    cct.moveToNext();
                                    name = cct.getString(cct.getColumnIndexOrThrow(CSDbFields.KEY_CONTACT_NAME));
                                }
                                cct.close();
                                if (name.equals("")) {
                                    name = destinationnumberr;
                                }

                                toolbarSubTitleTextView.setText(name + " is typing..");
              ...
              //notifyDataSetChanged(true,false,"");
                    ...
                    */
                    ...
                    chatAdapter.changeCursor(CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID,destination));
...
//					updateView(intent.getStringExtra("chatid"),"downloadfilefailed",0);
                    ...
                    */
                    ...
                    if (intent.getStringExtra(CSConstants.RESULT).equals(CSConstants.RESULT_SUCCESS)) {
                        ...
                        attachments.setEnabled(true);
                        mRecordButton.setEnabled(true);
                        mChatMessageEditText.setBackgroundResource(R.drawable.chat_bg);
                        if (name.equals("")) {

                            String namefromintent = getIntent().getStringExtra("grpname");
                            if (namefromintent.equals("")) {
                                toolbarTitleTextView.setText("Unknown Group");
                            } else {
                                toolbarTitleTextView.setText(namefromintent);
                            }
                        } else {
                        ...
                        mChatMessageEditText.setBackgroundResource(R.drawable.chat_bg_disable);
                    }
                } else if (intent.getAction().equals(CSEvents.CSGROUPS_DELETEDFROMGROUP)) {
                    if (intent != null) {
                        if (intent.getStringExtra("groupid").equals(destination)) {
                            mChatMessageEditText.setEnabled(false);
                            mSendButton.setEnabled(false);
                            attachments.setEnabled(false);
                            mRecordButton.setEnabled(false);
	...
	public void onResume() {
		...
		try {
            ...
            LOG.info("stack count in chat Activity:"+ App.getActivityStackCount());
            ...
            filter.addAction(CSEvents.CSGROUPS_PULLGROUPDETAILS_RESPONSE);
            filter.addAction(CSEvents.CSGROUPS_DELETEDFROMGROUP);
            filter.addAction(CSEvents.CSGROUPS_GROUPDELETEDTOGROUP);
            filter.addAction(CSEvents.CSGROUPS_GROUPINFO_UPDATED);
            filter.addAction(CSEvents.CSCLIENT_IMAGESDBUPDATED);
            ...
            int is_grp_active = 0;
            Cursor cur = CSDataProvider.getGroupsCursorByFilter(CSDbFields.KEY_GROUP_ID, destination);
            if (cur.getCount() > 0) {
                cur.moveToNext();
                is_grp_active = cur.getInt(cur.getColumnIndexOrThrow(CSDbFields.KEY_GROUP_IS_ACTIVE));
                if(is_grp_active == 1) {
                    if (cur.getInt(cur.getColumnIndexOrThrow(CSDbFields.KEY_GROUP_IS_BLOCKED)) == 0) {
                        is_grp_active = 1;
                    } else {
                        is_grp_active = 0;
                    }
                }
                LOG.info("TEST IS GROUP ACTIVE CHAT:" + is_grp_active);
            }
            cur.close();
        ...
        switch (requestCode) {
            ...
            case IMAGE_CAPTURE_REQUEST_CODE:
                ...
                if (imageFile == null || imageFile.getAbsolutePath().equals("")) {
                    Toast.makeText(GroupChatAdvancedActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                } else {
...
LOG.info("IMAGE_GALLERY_REQUEST_CODE received");
            ...
            case DOCUMENTS_REQUEST_CODE:
                ...
                if (data != null && data.getData() != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(GroupChatAdvancedActivity.this, getResources().getString(R.string.wrong_document), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(GroupChatAdvancedActivity.this, getResources().getString(R.string.wrong_document), Toast.LENGTH_SHORT).show();
                }
            ...
            case LOCATION_REQUEST_CODE:
                ...
                if (data != null && resultCode != Activity.RESULT_CANCELED) {
                    CSChatObj.sendLocation(destination, new CSChatLocation(data.getDoubleExtra(ChatConstants.INTENT_LOCATION_LATITUDE,0.0),data.getDoubleExtra(ChatConstants.INTENT_LOCATION_LONGITUDE,0.0),data.getStringExtra(ChatConstants.INTENT_LOCATION_ADDRESS)), true);
                }
                ...
                try {
                    ...
                    if (data != null && resultCode == Activity.RESULT_OK) {
                        ...
                        if (chatid1 == null || chatid1.equals("") || numbers.isEmpty()) {
                            Toast.makeText(GroupChatAdvancedActivity.this, "Error", Toast.LENGTH_SHORT).show();
                            return;
                        } else {
                            Toast.makeText(GroupChatAdvancedActivity.this, "Forwarding..", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        for (String number : numbers) {
                            ...
                            try {
                                ...
                                if (type.equals(CSConstants.GROUP)) {
                                    isgroupmessage = true;
                                }
                                number = id;
                            } catch (Exception ex) {
                                ex.printStackTrace();
                                Toast.makeText(GroupChatAdvancedActivity.this, "skipped to a recipient", Toast.LENGTH_SHORT).show();
                                continue;
                            }
                        ...
                        if (numbers.size() == 1) {
                            boolean isgroupmessage = false;
                            JSONObject jsonObj = new JSONObject(numbers.get(0));
                            String id = jsonObj.getString("id");
                            String type = jsonObj.getString("type");
                            if (type.equals(CSConstants.GROUP)) {
                                isgroupmessage = true;
                            ...
                            String number = id;
                            if (isgroupmessage) {
                                Intent intent = new Intent(GroupChatAdvancedActivity.this, GroupChatAdvancedActivity.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            case CONTACT_REQUEST_CODE:
                if(resultCode == Activity.RESULT_OK && data != null) {
                    ...
                    for (int i = 0; i < contacts.size(); i++) {
                        ...
                        boolean result = CSChatObj.sendContact(destination, CSChatContactObj, true);
    ...
    private void showGalleryOptions() {
        final Dialog chatGalleryOptionDialog = new Dialog(GroupChatAdvancedActivity.this);
...
if(mdialog!=null&&mdialog.isShowing()){
    return;
			...
			mdialog = new MyProgressDialog(GroupChatAdvancedActivity.this);
    ...
    public void showProgressBar1() {
        try {
            ...
            mdialog1 = new ProgressDialog(GroupChatAdvancedActivity.this);
    ...
    public boolean showactivatelocationalert(String message) {
        try {
            AlertDialog.Builder successfullyLogin = new AlertDialog.Builder(GroupChatAdvancedActivity.this);
    ...
    private void notifyDataSetChanged(boolean focustounreadorbottom,boolean insearchmode,String searchstring,boolean isfocusneeded) {
        try {
            ...
            adp.swapCursorAndNotifyDataSetChanged(CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID,destination),insearchmode,searchstring);
...
*/
    ...
    private void showConfirmationDialog() {
        try {
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(GroupChatAdvancedActivity.this);
            ...
            dialog.setPositiveButton(("Send"), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    CSChatObj.sendAudio(destination, AudioSavePathInDevice, true);
                }
            });
...
private void setTitleName() {
        try {
            ...
            if(ccfr.getCount()>0) {
                ccfr.moveToNext();
                name = ccfr.getString(ccfr.getColumnIndexOrThrow(CSDbFields.KEY_GROUP_NAME));
                subtitle = ccfr.getString(ccfr.getColumnIndexOrThrow(CSDbFields.KEY_GROUP_DESC));
            }
            ccfr.close();

//LOG.info("Name in on resume1:"+name);
            //LOG.info("subtitle in on resume1:"+subtitle);
            //name = "";//temp test
            if(name.equals("")) {
                Cursor cr = CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_GROUPING_IDENTIFIER, destination);
                //LOG.info("Name in on chat name count:"+cr.getCount());
                if(cr.getCount()>0) {
                    cr.moveToLast();
                //while(cr.moveToNext()) {
                    //LOG.info("Name in on chat name in loop getCount:"+cr.getCount());
                    //LOG.info("Name in on chat name in loop getPosition:"+cr.getPosition());
                    name = cr.getString(cr.getColumnIndexOrThrow(CSDbFields.KEY_CHAT_DESTINATION_NAME));
                    //LOG.info("Name in on chat name:"+name);
                }
                cr.close();
            }

            //LOG.info("Name in on resume2:"+name);
            //LOG.info("subtitle in on resume2:"+subtitle);
...
try {
    ...
    String picid = "";
    Cursor cur1 = CSDataProvider.getGroupsCursorByFilter(CSDbFields.KEY_GROUP_ID, destination);
    if (cur1.getCount() > 0) {
        cur1.moveToNext();
    ...
    if (filepath != null && new File(filepath).exists()) {
        Glide.with(GroupChatAdvancedActivity.this)
        ...
        chatsearchrefcnt++;
                    ...
                    GroupChatAdvancedActivity.this.runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            Toast.makeText(GroupChatAdvancedActivity.this, "Not found", Toast.LENGTH_SHORT).show();
                        }
                    });
...
if(selectedpositions.size()>1) {
    ...
    Cursor cur1 =  CSDataProvider.getChatCursorByFilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID,destination);
    for(int cursorposition:selectedpositions) {
        cur1.moveToPosition(cursorposition);
        int issenderr =  cur1.getInt(cur1.getColumnIndex(CSDbFields.KEY_CHAT_IS_SENDER));
        if(issenderr !=1) {
            chatinfo = false;
        }
        break;
    ...
    cur1.close();
              ...
              if(showdelete) {
                ...
                if(chatinfo) {
                    chatinfoview.setVisibility(View.VISIBLE);
                } else {
                    chatinfoview.setVisibility(View.GONE);
                }
...
ex.printStackTrace();
    ...
    public boolean showdeletealert() {
        try {
            ...
            final Dialog successfullyLogin = new Dialog(GroupChatAdvancedActivity.this);
...
*/
            ...
            successfullyLogin.setPositiveButton("Delete",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog,
                            ...
                            CSChatObj.deleteChatMessagebyfilter(CSDbFields.KEY_CHAT_DESTINATION_GROUPID, destination);
                            notifyDataSetChanged(false,false,"",true);
        ...
        try {
            ...
            if (ContextCompat.checkSelfPermission(MainActivity.context, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(MainActivity.context, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                ...
                if (isSDPresent) {
                    ...
                    //LOG.info("yes SD-card is present from app:"+file.getAbsolutePath());
                    if (!file.exists()) {
                        if (!file.mkdirs()) {
    ...
    class SendFile extends AsyncTask<String, Integer, String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            String targetpath = GlobalVariables.docsdirectorysent;
            if(filetype.equals("audio")) {
                targetpath = GlobalVariables.audiodirectorysent;
            } else if(filetype.equals("video")) {
                targetpath = GlobalVariables.videodirectorysent;
            } else if(filetype.equals("gallaryimage")) {
                targetpath = GlobalVariables.imagedirectorysent;
            } else if(filetype.equals("cameraimage")) {
                targetpath = GlobalVariables.imagedirectorysent;
            } else {
                targetpath = GlobalVariables.docsdirectorysent;
            }
            //createDirIfNotExists(targetpath);
...
if(result!=null && !result.equals("")) {
    if(filetype.equals("audio")) {
        CSChatObj.sendAudio(destination, result, true);
    } else if(filetype.equals("video")) {
        //new ForeGroundServiceApis().startChatService(getApplicationContext(),destination,"Sending video");
        CSChatObj.sendVideo(destination, result, true);
    } else if(filetype.equals("gallaryimage")) {
        CSChatObj.sendPhoto(destination, result, true);
    } else if(filetype.equals("cameraimage")) {
        CSChatObj.sendPhoto(destination, result, true);
        if(imageFile.exists()) {
            imageFile.delete();
        ...
        CSChatObj.sendDocument(destination, result, true);
    }
}
cancelProgressBar1();
        }
