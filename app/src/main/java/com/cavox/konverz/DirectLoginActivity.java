...
public class DirectLoginActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        try {
            ...
            if (submitobj != null)
                submitobj.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //System.out.println("SR_LOG:SUBMIT");call_screen_call_type_audio
                        tellmenwerror = true;
                        try {
 ...
 */
                    ...
                    if (event.getAction() == MotionEvent.ACTION_UP) {
                        if (event.getRawX() >= (urlobj1.getRight() - urlobj1.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
                            if (showpassword) {
                                ...
                                showpassword = false;
                                urlobj1.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_password_hide, 0);

                            } else {
                                urlobj1.setTransformationMethod(null);
                                showpassword = true;
                                urlobj1.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_password_show, 0);
    ...
    public void showprogressbar() {
        try {
            if (getApplicationContext() != null) {
                progressBarStatus = 0;
                progressBar = new ProgressDialog(DirectLoginActivity.this);
    ...
    public boolean showalert(String result) {
        try {
            android.app.AlertDialog.Builder successfullyLogin = new android.app.AlertDialog.Builder(DirectLoginActivity.this);
