        ...
        mLocationLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(ChatAdvancedActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 102);
                }
                    ...
                    try {
                        ...
                        if(intent.getStringExtra(CSConstants.RESULT).equals(CSConstants.RESULT_SUCCESS)) {
                            ...
                            if (destination.equals(intent.getStringExtra("presencenumber"))) {
                                ...
                                LOG.info("lastseentime in app:"+lastseentime);
                ...
                try {
                    ...
                    if (data != null && resultCode == Activity.RESULT_OK) {
                        ...
                        if (numbers.size() == 1) {
                            ...
                            String number = id;
                            if (isgroupmessage) {
                                Intent intent = new Intent(ChatAdvancedActivity.this, GroupChatAdvancedActivity.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
