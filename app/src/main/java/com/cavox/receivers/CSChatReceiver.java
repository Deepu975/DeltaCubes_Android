...
String chatid = intent.getStringExtra("chatid");
                    LOG.info("Chat Receieved in CSChatReceiver chatid:"+chatid);
                    ...
                    while(cur.moveToNext()) {
                        ...
                        //LOG.info("Chat Receieved in CSChatReceiver chatidd:"+chatidd);
                        //LOG.info("Chat Receieved in CSChatReceiver issender:"+issender);
                        //LOG.info("Chat Receieved in CSChatReceiver lastissender:"+lastissender);

                        if(chatidd.equals(chatid)&&lastissender == 1) {
                                     lastissender = issender;
                                 }
                        //LOG.info("Chat Receieved in CSChatReceiver issender after:"+issender);
                        //LOG.info("Chat Receieved in CSChatReceiver lastissender after:"+lastissender);
                    ...
                    if (!destination.equals(GlobalVariables.inchatactivitydestination)&&lastissender == 0) {
