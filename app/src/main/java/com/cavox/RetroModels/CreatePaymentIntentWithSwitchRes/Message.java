...
public class Message {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("object", object).append("allowedSourceTypes", allowedSourceTypes).append("amount", amount).append("amountCapturable", amountCapturable).append("amountReceived", amountReceived).append("application", application).append("applicationFeeAmount", applicationFeeAmount).append("canceledAt", canceledAt).append("cancellationReason", cancellationReason).append("captureMethod", captureMethod).append("charges", charges).append("clientSecret", clientSecret).append("confirmationMethod", confirmationMethod).append("created", created).append("currency", currency).append("customer", customer).append("description", description).append("invoice", invoice).append("lastPaymentError", lastPaymentError).append("livemode", livemode).append("metadata", metadata).append("nextAction", nextAction).append("nextSourceAction", nextSourceAction).append("onBehalfOf", onBehalfOf).append("paymentMethod", paymentMethod).append("paymentMethodOptions", paymentMethodOptions).append("paymentMethodTypes", paymentMethodTypes).append("receiptEmail", receiptEmail).append("review", review).append("setupFutureUsage", setupFutureUsage).append("shipping", shipping).append("source", source).append("statementDescriptor", statementDescriptor).append("statementDescriptorSuffix", statementDescriptorSuffix).append("status", status).append("transferData", transferData).append("transferGroup", transferGroup).toString();
    }
