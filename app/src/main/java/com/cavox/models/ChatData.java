...
public class ChatData {
    ...
    private boolean isSender, isGroupMessage, isMediaDownloadingOrUploading = false, isOriginalImageLoaded = false, isChatSelected = false, isUnreadMessage = false;
    private int messageStatus, messageType, mediaUploadingOrDownloadingPercentage, audioProgress,isMultiDeviceMessage;
